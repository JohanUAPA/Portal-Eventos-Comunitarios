...
Este proyecto es una aplicación de gestión de eventos comunitarios que permite a los usuarios registrarse, inscribirse en eventos y dejar comentarios. A continuación se detallan las instrucciones para instalar y utilizar el proyecto.
